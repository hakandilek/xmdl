...
public class EntityServiceImplementationImpl
{
  protected static String nl;
  public static synchronized EntityServiceImplementationImpl create(String lineSeparator)
  {
    nl = lineSeparator;
    EntityServiceImplementationImpl result = new EntityServiceImplementationImpl();
    nl = null;
    return result;
  }
