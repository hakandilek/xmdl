...
import chrome.xmdl.presentation.XmdlEditor;
import chrome.xmdldb.ui.XmdldbEditPlugin;

import chrome.xmdldb.ui.*;
...
/**
 * This is the action bar contributor for the Xmdldb model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class XmdldbActionBarContributor extends
	...
	protected IAction refreshViewerAction = new Action(
			XmdldbEditPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
	 ...
	 * @generated
	 */
	public XmdldbActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("xmdldb-settings"));
		toolBarManager.add(new Separator("xmdldb-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(XmdldbEditPlugin.INSTANCE
				.getString("_UI_XmdldbEditor_menu"), "chrome.xmdldbMenuID");
		...
		//
		createChildMenuManager = new MenuManager(XmdldbEditPlugin.INSTANCE
				.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(XmdldbEditPlugin.INSTANCE
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(XmdldbEditPlugin.INSTANCE
				.getString("_UI_CreateChild_menu_item"));
