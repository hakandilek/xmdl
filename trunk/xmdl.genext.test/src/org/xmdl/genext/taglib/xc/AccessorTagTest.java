...
public class AccessorTagTest extends BaseTemplateTestCase {
    ...
    public void testAccessors() throws BundleException {

        final String templateClass = AccessorTagTestTemplate.class.getName();
        ...
        assertEquals(":getAttribute1", pieces[0].trim());
        assertEquals(":isAttribute2", pieces[1].trim());
        assertEquals(":isAttribute3", pieces[2].trim());
    }
