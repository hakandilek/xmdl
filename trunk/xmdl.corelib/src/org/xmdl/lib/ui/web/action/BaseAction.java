...
import org.xmdl.lib.helper.CurrencyConverter;
import org.xmdl.lib.helper.DateConverter;
import org.xmdl.lib.helper.GeneralConstants;
...
//    /**
//     * @see ConvertUtil#convert(java.lang.Object)
//     */
...
//
//    /**
//     * @see ConvertUtil#convertLists(java.lang.Object)
//     */
...
//    }
    ...
    throws Exception {
        ...
        if (actionMethod != null) {
            ...
            for (int i = 0; i < rules.length; i++) {
                ...
                if (servletPath!= null && servletPath.indexOf(rules[i]) > -1) {
    ...
    public Map getConfiguration() {
        Map config = (HashMap) getServlet().getServletContext().getAttribute(GeneralConstants.CONFIG);
