...
public class StrutsConfigXMLImpl
{
  ...
  protected final String TEXT_6 = NL + "    </form-beans>" + NL + "" + NL + "    <!-- ========== Global Exceptions Definitions =================================== -->" + NL + "    <global-exceptions>" + NL + "        <exception type=\"java.lang.Exception\"" + NL + "            key=\"errors.general\"" + NL + "            handler=\"org.xmdl.lib.ui.web.action.ExceptionHandleAction\"/>" + NL + "    </global-exceptions>" + NL + "" + NL + "    <!-- ========== Global Forward Definitions =================================== -->" + NL + "    <global-forwards>" + NL + "" + NL + "        <forward name=\"home\" path=\"/include/home.jsp\"/>" + NL + "        " + NL + "        <!-- Logout by forward to a JSP, I do this b/c if I forward to an" + NL + "             an action, and the users session is expired - they'll be prompted" + NL + "             to login - just to logout!  Seems silly to me." + NL + "        -->" + NL + "        <forward name=\"logout\" path=\"/logout.jsp\"/>        " + NL + "        ";
  ...
  protected final String TEXT_14 = "\"" + NL + "            type=\"org.xmdl.lib.ui.web.action.DelegatingAction\"" + NL + "            name=\"";
  ...
  protected final String TEXT_17 = "\"" + NL + "            type=\"org.xmdl.lib.ui.web.action.DelegatingAction\"" + NL + "            name=\"";
  ...
  protected final String TEXT_24 = NL + NL + "        <!-- Forwards to the home -->" + NL + "        <action path=\"/home\" type=\"org.apache.struts.actions.ForwardAction\"" + NL + "            parameter=\"/include/home.jsp\"/>" + NL + "" + NL + "    </action-mappings>" + NL + "" + NL + "    <controller nocache=\"true\" inputForward=\"true\" maxFileSize=\"2M\"/>" + NL;
