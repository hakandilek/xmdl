...
public class CallFunctionTest extends BaseTemplateTestCase {
    ...
    public void testEvaluate() {
        final String templateClass = MethodCallFunctionTestTemplate.class.getName();
        ...
        assertEquals("isPrimitive", pieces[1].trim());
        assertEquals("", pieces[2].trim());
        assertEquals("isPrimitive", pieces[3].trim());
        assertEquals("", pieces[4].trim());
        assertEquals("isPrimitive", pieces[5].trim());
        assertEquals("", pieces[6].trim());
        assertEquals("isPrimitive", pieces[7].trim());
        assertEquals("", pieces[8].trim());
        assertEquals("", pieces[9].trim());
    }
