...
public class RandomWrapTagTest extends BaseTemplateTestCase {
    ...
    public void testRandomValuePlain() throws BundleException {
        ...
        final String templateClass = RandomWrapTagTestTemplatePlain.class.getName();
        ...
        assertEquals(17, pieces[1].trim().length());
        ...
        try {
            ...
            assertNotSame("", a);
            assertNotSame("", b);
            assertTrue("Enumeration1.VALUE1".equals(a) || "Enumeration1.VALUE2".equals(a));
            assertTrue("Enumeration1.VALUE1".equals(b) || "Enumeration1.VALUE2".equals(b));
            assertEquals(a, b);
        } catch (Exception e) {
            fail("parsing failed");
        }
    ...
    public void testRandomValueTrim() throws BundleException {
        ...
        final String templateClass = RandomWrapTagTestTemplateTrim.class
                .getName();
        setVariable("attribute1", attribute1);
        setVariable("attribute2", attribute2);
        setVariable("attribute3", attribute3);
