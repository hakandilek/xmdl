...
import org.xmdl.xmdl.ui.perspective.XmdlModelingPerspective;
 ...
 * @generated
 */
public final class XmdlEditorAdvisor extends WorkbenchAdvisor {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	private static String getString(String key) {
		return XMDLUIPlugin.INSTANCE.getString(key);
	}
	...
	private static String getString(String key, Object s1) {
		return org.xmdl.xmdl.ui.XMDLUIPlugin.INSTANCE.getString(key,
				new Object[] { s1 });
	}
	...
	public static class Application implements IApplication {
		...
		public Object start(IApplicationContext context) throws Exception {
			WorkbenchAdvisor workbenchAdvisor = new XmdlEditorAdvisor();
	...
	/**
	 * Open action for the objects from the Xmdl model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static class OpenAction extends WorkbenchWindowActionDelegate {
		 ...
		 */
		public void run(IAction action) {
			String filePath = openFilePathDialog(getWindow().getShell(), null,
					SWT.OPEN);
			if (filePath != null) {
	...
	/**
	 * Open URI action for the objects from the Xmdl model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public static boolean openEditor(IWorkbench workbench, URI fileURI) {
		...
		if (editorDescriptor == null) {
			MessageDialog.openError(workbenchWindow.getShell(),
					getString("_UI_Error_title"), getString("_WARN_No_Editor",
