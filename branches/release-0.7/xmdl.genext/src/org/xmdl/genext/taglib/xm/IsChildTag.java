...
/**
 * This tag checks whether the given element is a child attribute or class.
 * 
 * @author Hakan Dilek
 * 
 */
public class IsChildTag extends BaseConditionalTag {
	...
	public boolean doEvalCondition(TagInfo td, JET2Context context)
		...
		if (object instanceof XClass) {
			...
			eval = MetadataTagUtils.isChild(xClass);
		} else if (object instanceof XAttribute) {
			XAttribute xAttribute = (XAttribute) object;
			eval = MetadataTagUtils.isChild(xAttribute);
		}
