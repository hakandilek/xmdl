...
import org.xmdl.wdl.gen.utils.Association;
import org.xmdl.wdl.gen.utils.AssociationManager;
import org.xmdl.wdl.gen.utils.AssociationType;
...
public class IDAExtensionUtils extends ExtensionUtils {
	...
	public static String randomize(Attribute a, String variant) {
		return IDATestUtils.INSTANCE.randomValueAsString(a, variant);
	}

	public static String randomizeWrap(Attribute attrib, String variant) {
		String val = IDATestUtils.INSTANCE.randomValueAsString(attrib, variant);
	...
	public static String randomize(Attribute attribute, String variant,
			String format) {
		Type type = attribute.getType();
		Object value = IDATestUtils.INSTANCE.randomValuePlain(attribute, variant);
		String plain = "";
