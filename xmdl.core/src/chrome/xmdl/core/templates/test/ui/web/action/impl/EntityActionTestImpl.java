...
public class EntityActionTestImpl
{
  ...
  protected final String TEXT_11 = "Form);" + NL + "" + NL + "        verifyActionMessages(new String[] {\"chrome.xmdl.demo.model.";
  ...
  protected final String TEXT_24 = "Form);" + NL + "" + NL + "        verifyActionMessages(new String[] {\"chrome.xmdl.demo.model.";
