...
public class FormFieldDoubleImpl
{
  ...
  public static synchronized FormFieldDoubleImpl create(String lineSeparator)
  {
    nl = lineSeparator;
    FormFieldDoubleImpl result = new FormFieldDoubleImpl();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_7 = "\" editType=\"formatDouble\" />";
