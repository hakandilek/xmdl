...
public class FormFieldBooleanImpl
{
  protected static String nl;
  public static synchronized FormFieldBooleanImpl create(String lineSeparator)
  {
    nl = lineSeparator;
    FormFieldBooleanImpl result = new FormFieldBooleanImpl();
    nl = null;
    return result;
  }

  public final String NL = nl == null ? (System.getProperties().getProperty("line.separator")) : nl;
  protected final String TEXT_1 = "<layout:checkbox name=\"";
