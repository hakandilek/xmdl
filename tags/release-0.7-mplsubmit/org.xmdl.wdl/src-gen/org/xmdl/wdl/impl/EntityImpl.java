 ...
 * <ul>
 *   <li>{@link org.xmdl.wdl.impl.EntityImpl#getSuperEntity <em>Super Entity</em>}</li>
 *   <li>{@link org.xmdl.wdl.impl.EntityImpl#getAttributes <em>Attributes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EntityImpl extends TypeImpl implements Entity
{
  ...
  {
    return WdlPackage.Literals.ENTITY;
  }
    ...
    if (superEntity != null && superEntity.eIsProxy())
    {
      ...
      if (superEntity != oldSuperEntity)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, WdlPackage.ENTITY__SUPER_ENTITY, oldSuperEntity, superEntity));
      }
    }
    return superEntity;
  }
  ...
  public void setSuperEntity(Entity newSuperEntity)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, WdlPackage.ENTITY__SUPER_ENTITY, oldSuperEntity, superEntity));
  }
  ...
  public EList<Attribute> getAttributes()
  {
    if (attributes == null)
    {
      attributes = new EObjectContainmentEList<Attribute>(Attribute.class, this, WdlPackage.ENTITY__ATTRIBUTES);
    }
    return attributes;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case WdlPackage.ENTITY__ATTRIBUTES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case WdlPackage.ENTITY__SUPER_ENTITY:
