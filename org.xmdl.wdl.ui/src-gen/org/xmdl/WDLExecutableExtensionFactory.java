 ...
 * generated
 */
public class WDLExecutableExtensionFactory implements IExecutableExtensionFactory, IExecutableExtension {

	private Logger log = Logger.getLogger(WDLExecutableExtensionFactory.class);
	...
	public Object create() throws CoreException {
		org.xmdl.internal.WDLActivator instance = org.xmdl.internal.WDLActivator.getInstance();
		if (instance == null)
		...
		try {
			...
			final Injector injector = org.xmdl.internal.WDLActivator.getInstance().getInjector("org.xmdl.WDL");
